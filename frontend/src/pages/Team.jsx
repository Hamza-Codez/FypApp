...
import { fetchEmployees, fetchProjects } from "../features/workspaceSlice";
                            ...
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-zinc-800">
                                ...
                                <tbody className="divide-y divide-gray-200 dark:divide-zinc-800">
                                    {filteredUsers.map((emp) => (
                                        <tr key={emp.id} className="hover:bg-gray-50 dark:hover:bg-zinc-800/50 transition-colors">
                                            <td className="px-6 py-2.5 whitespace-nowrap flex items-center gap-3">
                                                <div className="size-7 rounded-full bg-blue-100 dark:bg-blue-500/10 flex items-center justify-center border border-blue-200 dark:border-blue-500/20">
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="mt-2">
                                              <span className="px-2 py-0.5 text-[10px] font-bold rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-500 border border-zinc-200 dark:border-zinc-700 uppercase tracking-widest">
                                                {emp.role}
                                              </span>
                                            </div>
                                        </div>
